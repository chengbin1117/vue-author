        ...
        <el-col :span="24">
          <el-form ref="form" :model="form" :rules="rules">
            <el-form-item label="标题：" label-width="102px" prop ="title"  id="myTitle">
              <el-input v-model="form.title"  placeholder="请在这里输入文章标题" class="videotitle"  @blur = "autoSave">
               <span slot="suffix" class="num">{{titleNum}}/64</span>
              </el-input>
            </el-form-item>
            <el-form-item label="视频：" label-width="102px" id="myVideo">
              <el-radio-group v-model="form.videoType" change = "autoSave">
            ...
            <el-form-item v-if = "form.videoType === '2'" label-width="102px" prop="videoInfo2" class="videoUrl">
                 <div  >
                  <el-input  size = 'small' v-model="form.videoInfo2" placeholder = '示例：<iframe frameborder="0" width="640" height="498" src="……" allowfullscreen> </iframe>' change = "autoSave"></el-input>
            ...
            <el-form-item label="视频简介：" label-width="102px" prop="textarea" class="area" id="myVideoIntro">
              <el-input type="textarea" placeholder="请输入视频简介" v-model="form.textarea" @change = "autoSave"></el-input>
            </el-form-item>
            ...
            <div v-if = "form.articleType === '' ? false : true">
              <el-form-item  v-if = "form.articleType == 1 ? false : true" label="视频来源：" prop = "articleSource" label-width="102px" id="myVideoSource">
                <el-input size = 'small' v-model="form.articleSource" placeholder = '请输入视频来源网站名称，如**网' @change = "autoSave"></el-input>
              </el-form-item>
              <el-form-item  v-if = "form.articleType == 1 ? false : true" label="来源地址：" prop = "articleLink" label-width="102px">
                <el-input size = 'small' v-model="form.articleLink" placeholder = '请输入视频来源地址' @change = "autoSave"></el-input>
              </el-form-item>
            </div>
...
export default {
  ...
  beforeRouteLeave: function(to, from , next){
    if(this.isPublish){
      if(!this.form.title&&!this.form.textarea&&!this.form.tag&&!this.form.listCoverImgPost&&!this.form.title
        &&!this.form.award&&!this.form.articleType&&!this.form.videoFilename) {
        next()
      }else {
        next(false)
  ...
  methods: {
    ...
    handleRemove(files, fileList) {
      console.log(fileList,this.form.videoInfo)
