          ...
          <el-col :span="24">
            <el-form ref="form" :model="form" class="articleForm" :rules="rules">
              <el-form-item prop="title" id="myTitle">
                <el-input v-model="form.title"  placeholder="请在这里输入文章标题" class="title"></el-input>
              ...
              <el-form-item id="myTag" class = 'marginTop' label="Tag标签：" prop = 'tag' label-width="102px">
              ...
              <el-form-item label="文章摘要：" id="myArticle" prop = 'textarea' label-width="102px">
                <el-input
                  size = "small"
                  type="textarea"
                  placeholder="请输入文章摘要"
              ...
              <div v-if = "form.articleType === '' ? false : true">
                <el-form-item id="myArticleSource"  v-if = "form.articleType == 1 ? false : true" label="文章来源：" prop = "articleSource" label-width="102px">
                  <el-input size = 'small' v-model="form.articleSource" placeholder = '请输入文章来源网站名称，如**网' ></el-input>
                </el-form-item>
                <el-form-item  v-if = "form.articleType == 1 ? false : true" label="原文地址：" prop = "articleLink" label-width="102px">
                  <el-input size = 'small' v-model="form.articleLink" placeholder = '请输入文章来源地址' ></el-input>
                </el-form-item>
              </div>
...
export default {
  ...
  methods: {
    ...
    pushHistory() {
      var bool =  window.confirm("您还未保存文章，确定需要退出吗?");
      const _this = this
        if(bool) {
          history.go('-1')
      ...
      this.ajax({
        ...
        success(data) {
          if(data.code === '10000') {
              ...
              _this.editorContentHtml = res.articleText;
              _this.content = res.articleText;
...
.publishArticle {
  ...
  border-radius: 10px;
  box-shadow: 0px 5px 2px rgba(183, 182, 182, 0.1);
